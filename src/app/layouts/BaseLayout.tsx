  ...
  return (
    <div className="bg-custom-bg min-h-screen flex flex-col">
      ...
      <div className="w-full max-w-[1366px] mx-auto pl-2 pr-2 flex-grow flex flex-col">
        ...
        <div className="flex flex-col nav:flex-row nav:justify-between pt-2">
          <aside className="hidden nav:block w-full nav:w-[20%] mb-4 pl-2 pr-4">
          ...
          <main className="w-full nav:w-[60%] bg-custom-bg nav:p-2 p-0 overflow-y-auto mb-4">
            {mainContent}
          </main>

          <aside className="hidden nav:block w-full nav:w-[20%] mb-4 pl-4">
            <div className="sticky custom-scrollbar nav:top-4 overflow-y-auto max-h-[calc(100vh_-_var(--header-height)_-_var(--footer-height))]">
              {rightSidebar}
            </div>
          </aside>
