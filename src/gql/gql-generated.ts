...
/** The book type */
export type Book = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfBookDetails & {
  __typename?: 'Book';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
...
export type PlaceholderSettingsFields = AcfFieldGroup & AcfFieldGroupFields & PlaceholderSettingsFields_Fields & {
  ...
  placeholderSetup?: Maybe<Array<Maybe<PlaceholderSettingsFieldsPlaceholderSetup>>>;
};
...
export type PlaceholderSettingsFieldsPlaceholderSetup = AcfFieldGroup & AcfFieldGroupFields & PlaceholderSettingsFieldsPlaceholderSetup_Fields & {
  ...
  contentSelector?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;PlaceholderSettingsFieldsPlaceholderSetup&quot; Field Group */
  placeholderSelector?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PlaceholderSettingsFieldsPlaceholderSetup&quot; Field Group */
  textContentGroup?: Maybe<PlaceholderSettingsFieldsPlaceholderSetupTextContentGroup>;
};
...
export type User = Commenter & DatabaseIdentifier & Node & UniformResourceIdentifiable & {
  ...
  books?: Maybe<UserToBookConnection>;
...
export type UserBooksArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<UserToBookConnectionWhereArgs>;
};
...
/** Connection between the User type and the book type */
export type UserToBookConnection = BookConnection & Connection & {
  __typename?: 'UserToBookConnection';
  /** Edges for the UserToBookConnection connection */
  edges: Array<UserToBookConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Book>;
  /** Information about pagination in a connection. */
  pageInfo: UserToBookConnectionPageInfo;
};

/** An edge in a connection */
export type UserToBookConnectionEdge = BookConnectionEdge & Edge & {
...
/** Page Info on the &quot;UserToBookConnection&quot; */
export type UserToBookConnectionPageInfo = BookConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'UserToBookConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type UserToBookConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
